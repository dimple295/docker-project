...
# The rest of your UserService code goes here...
...
def borrow_book():
    ...
    # Make a GET request to the external API to check borrowed books
    try:
        response = requests.get(f'http://borrow-service:6000/borrowed_books/{student_id}')
        if response.status_code == 200:
            borrowed_books = response.json()

            # Check if the student has borrowed 5 or more books
    ...
    # Publish the data to RabbitMQ if the student has less than 5 books
